 ...
 * @param includeKeys pole opcjonalne zawierające liste wartości kluczy które mają być uwzględniane przy wyniku
 * @param excludeKeys pole opcjonalne zawierające liste wartości kluczy które nie mają być uwzględniane przy wyniku
 */
